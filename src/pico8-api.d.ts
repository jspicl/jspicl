/**
 * PICO-8 v0.2.7 Complete API Type Definitions
 */

export namespace PICO8 {
  // ===== Graphics =====
  export function cls(col?: number): void;
  export function camera(x?: number, y?: number): void;
  export function clip(x?: number, y?: number, w?: number, h?: number): void;
  export function pset(x: number, y: number, col?: number): void;
